...
INP = "data/processed/similarity_cosine_stage2_mentions.csv"
OUT = "data/processed/louvain_communities_stage2_mentions.csv"

THRESH = 0.70  # ajustaremos según distribución
